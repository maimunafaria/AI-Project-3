...
parser.add_argument('--model_dir', type=str, default='D://Image-Editing-using-GAN//DCGAN//dcgan_model//New', help='Path to the model directory')
parser.add_argument('--sampled_dir', type=str, default='D:\Image-Editing-using-GAN\DCGAN\gen_images_test', help='Path to the test images')
